...
use concrete_core::prelude::{
    LweSeededCiphertextEncryptionEngine, LweSeededToLweCiphertextTransmutationEngine,
};
...
impl PrototypesLweSeededCiphertext<Precision32, BinaryKeyDistribution> for Maker {
    ...
    fn transmute_lwe_seeded_ciphertext_to_lwe_ciphertext(
        ...
        ProtoBinaryLweCiphertext32(
            self.default_engine
                .transmute_lwe_seeded_ciphertext_to_lwe_ciphertext(seeded_ciphertext.0.to_owned())
                .unwrap(),
        )
    }
}
