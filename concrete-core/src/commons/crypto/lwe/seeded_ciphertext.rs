...
use crate::commons::math::random::{RandomGenerable, RandomGenerator, Seed, Uniform};
...
impl<Scalar: Numeric> LweSeededCiphertext<Scalar> {
    ...
    {
        // TODO: find a way to instantiate an efficient RandomGenerator potentially provided by an
        // engine. This is ok for the current DefaultEngine as it's supposed to be hardware agnostic
        let mut generator = RandomGenerator::<SoftwareRandomGenerator>::new(self.seed);
